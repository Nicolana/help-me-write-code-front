<template>
    <div class="chat-bot-container">
        ...
        <div class="chat-bot-wrap flex h-[calc(100vh-60px-24px-24px)] rounded-[0.5rem] overflow-hidden w-full">
            <div class="chat-bot-history w-[280px] bg-[rgb(245,245,245)] px-[16px] py-[16px] rounded-lg flex flex-col">
                        ...
                        <div>
                            ...
                            >
                                <div class="mb-4 flex items-center" >
                                    ...
                                    <div class="text-[14px]">
                                        <div v-if="message.type === MessageType.User">{{ username }}</div>
                                        <div v-else>System</div>
                                    </div>
                                </div>
                                <div class="flex-1 text-[14px] w-full bg-[rgba(240,242,246,0.5)] p-4 rounded-lg">
